...
public class inicioCliente extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_proveedor) {
            fragment=new fragmentProveedor();
            fragmentTransaction=true;

        } else if (id == R.id.nav_buscar) {

        } else if (id == R.id.nav_mcalificaciones) {
            fragment=new fragment_calificaciones();
            fragmentTransaction=true;

        }else if (id == R.id.nav_reservas){
            fragment=new fragment_Reservas();
            fragmentTransaction=true;
